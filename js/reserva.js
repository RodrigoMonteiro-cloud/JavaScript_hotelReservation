...
function checkEmail(){
    ...
    if(positionOfAtTeRate < positionOfDot && letterCheck != 'invalid'){
            ...
            elemail_feedback.textContent = 'Insira um email';
    }
}
...
function checkContact(minLength){
    ...
    if(numberCheck){
        ...
        elcontact_feedback.innerHTML = 'Digite o número correto';
    }
...
elcontact.addEventListener('blur', function(){ checkContact(10); }, false);
   ...
   //variable declarations
    ...
    if (bookedSilverRooms == null){
        totalSilverRooms = 8;
        bookedSilverRooms = 0;
        availableSilverRooms = 8;
     }
    if (bookedGoldRooms == null){
        totalGoldRooms = 6;
        bookedGoldRooms = 0;
        availableGoldRooms = 6;
     }
    if (bookedPlatinumRooms == null){
        totalPlatinumRooms = 5;
        bookedPlatinumRooms = 0;
        availablePlatinumRooms = 5;
     }
